...
// FILE_TRANSFERDlg.cpp : implementation file
//
...
BOOL CFILETRANSFERDlg::OnInitDialog()
{
	...
	CFont* fontbutton = new CFont();
	fontbutton->CreateFontW(48, 0, 0, 0, FW_DONTCARE, FALSE, FALSE, FALSE, DEFAULT_CHARSET, OUT_OUTLINE_PRECIS, CLIP_DEFAULT_PRECIS, CLEARTYPE_QUALITY, VARIABLE_PITCH, TEXT("Times New Roman"));
	GetDlgItem(IDC_BUTTON1)->SetFont(fontbutton);
	GetDlgItem(IDC_BUTTON2)->SetFont(fontbutton);
...
{
	rcv receive_button = new rcv;
	receive_button.DoModal();
}
